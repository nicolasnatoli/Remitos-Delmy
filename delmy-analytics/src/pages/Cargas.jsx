    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 900 }}>
      ...
      <div style={{ ...PANEL, borderColor: 'var(--teal)', background: 'var(--panel2)' }}>
        ...
        <div style={{ fontSize: 11, color: 'var(--mut)', lineHeight: 1.6 }}>
          Subí planillas mensuales o diarias en formato <strong style={{color:'var(--txt)'}}>DELMY PARTY SRL_DetalleDeVentasRealizadas_*.xlsx</strong>.<br/>
      ...
      >
        <input
          id="file-input" type="file" accept=".xlsx,.xls"
          style={{ display: 'none' }}
        ...
        {uploading ? (
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: 'var(--mut)' }}>
              Formato: DELMY PARTY SRL_DetalleDeVentasRealizadas_*.xlsx
            </div>
          </div>
        )}
      </div>
